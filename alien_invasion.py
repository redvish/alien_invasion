...
class AlienInvasion:
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Происходит то, что и при столкновении с кораблем
                self._ship_hit()
                break
    ...
    def _update_screen(self):
        ...
        # Кнопка Play отображается в том случае, если игры неактивна
